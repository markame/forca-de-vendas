...
public class FaturaDTO implements Serializable {
    ...
    public FaturaDTO(Integer idItem, Integer quantide) {
        this.idItem = idItem;
        this.quantide = quantide;
    }

    public FaturaDTO(Integer id, Integer idItem, Integer quantide) {
        this.id = id;
        this.idItem = idItem;
        this.quantide = quantide;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FaturaDTO)) {
            return false;
        }
        FaturaDTO other = (FaturaDTO) object;
